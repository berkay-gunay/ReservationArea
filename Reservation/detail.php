...
// Veriyi al
$sql_select = "SELECT adress, phone, gsm, mail, foother, facebook, twitter, instagram, youtube, lk FROM theme_settings ";
...
<body>
                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-outline card-info">
                        ...
                        <div class="invoice p-3 mb-3">
                            ...
                            if ($id) {
                                // SQL sorgusu: reservations ve guests tablolarını birleştirerek verileri al
                                $sql = "
    SELECT 
        reservations.id,
    ...
    INNER JOIN 
        room_type_name ON rooms.room_type = room_type_name.id  -- rooms ile roomtype birleştiriliyor
    INNER JOIN 
